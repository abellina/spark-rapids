...
<a name="sql.exec.BroadcastHashJoinExec"></a>spark.rapids.sql.exec.BroadcastHashJoinExec|Implementation of join using broadcast data<br>_Rules_:<sub><br>* Supports inner, (full, left, right)-outer, left-semi, left-anti </sub><sub><br>* Conditions not supported for (full, left, right)-outer, left-semi and left-anti joins </sub><sub><br>* full-outer is supported if keys are not nullable </sub><sub><br>* build side must be a GPU broadcast </sub>|true|None|
...
<a name="sql.exec.ShuffledHashJoinExec"></a>spark.rapids.sql.exec.ShuffledHashJoinExec|Implementation of join using hashed shuffled data<br>_Rules_:<sub><br>* Supports inner, (full, left, right)-outer, left-semi, left-anti </sub><sub><br>* Conditions not supported for (full, left, right)-outer, left-semi and left-anti joins </sub><sub><br>* full-outer is supported if keys are not nullable </sub>|true|None|
<a name="sql.exec.SortMergeJoinExec"></a>spark.rapids.sql.exec.SortMergeJoinExec|Sort merge join, replacing with shuffled hash join<br>_Rules_:<sub><br>* Supports inner, (full, left, right)-outer, left-semi, left-anti </sub><sub><br>* Conditions not supported for (full, left, right)-outer, left-semi and left-anti joins </sub><sub><br>* full-outer is supported if keys are not nullable </sub><sub><br>* SortMergeJoin replaced with HashJoin if configured </sub>|true|None|
