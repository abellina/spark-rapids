...
import org.apache.spark.sql.rapids.shims.spark311.{GpuInMemoryTableScanExec, GpuSchemaUtils, HadoopFSUtilsShim, ShuffleManagerShim}
import org.apache.spark.sql.sources.BaseRelation
import org.apache.spark.sql.types.{ArrayType, DataType, DataTypes, MapType, Metadata, StructType}
import org.apache.spark.storage.{BlockId, BlockManagerId}

class Spark311Shims extends PluginShims {
