...
object RapidsConf {
  ...
  val SHUFFLE_COMPRESSION_LZ4_BATCH_SIZE = conf("spark.rapids.shuffle.compression.lz4.chunkSize")
...
class RapidsConf(conf: Map[String, String]) extends Logging {
  ...
  lazy val  shuffleCompressionLz4BatchSize: Long = get(SHUFFLE_COMPRESSION_LZ4_BATCH_SIZE)
