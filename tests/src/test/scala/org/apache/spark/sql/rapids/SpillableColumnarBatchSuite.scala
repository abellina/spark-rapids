...
import com.nvidia.spark.rapids.{RapidsBufferBase, RapidsBufferCatalog, RapidsBufferId, RapidsDeviceMemoryStore, SpillableColumnarBatchImpl, StorageTier}
...
class SpillableColumnarBatchSuite extends AnyFunSuite {
  ...
  class MockBuffer(override val id: RapidsBufferId, catalog: RapidsBufferCatalog)
    extends RapidsBufferBase(id, null, 0, catalog) {
