...
case class SQLTaskAggMetricsProfileResult(
    ...
    rapidsShuffleWriteIoTimeNsSum: Long,
    dataSizeBytesSum: Long,
    dataReadSizeBytesSum: Long,
    rapidsShuffleDeserializationTimeNsSum: Long,
    rapidsShuffleSerializationTimeNsSum: Long,
  ...
  override def convertToSeq: Seq[String] = {
    ...
    val deserializationTimeMsSum =
      TimeUnit.NANOSECONDS.toMillis(rapidsShuffleDeserializationTimeNsSum).toDouble
    val serializationTimeMsSum =
      TimeUnit.NANOSECONDS.toMillis(rapidsShuffleSerializationTimeNsSum).toDouble
    val writeIoTimeMsSum =
      TimeUnit.NANOSECONDS.toMillis(rapidsShuffleWriteIoTimeNsSum).toDouble
