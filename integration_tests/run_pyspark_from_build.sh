...
then
    ...
    export PYSP_TEST_spark_driver_extraJavaOptions="-ea -Duser.timezone=UTC $COVERAGE_SUBMIT_FLAGS -agentlib:jdwp=transport=dt_socket,server=y,suspend=y -Dai.rapids.refcount.debug=true"
